---
title: "C.1. Analysis by Type of Pejoration"
---
...
crosstabs = rbind(crosstab(df$prof_trad, df$pej_antidem, "Media History", "Antidemocratic"), 
                  crosstab(df$prof_trad, df$pej_hist, "Media History", "Historical"), 
                  crosstab(df$prof_trad, df$pej_cont, "Media History", "Contemporary"), 
                  crosstab(df$prof_trad, df$pej_ill, "Media History", "Illiberal"),
                  crosstab(df$prof_trad, df$pej_pop, "Media History", "Populist"),
                  crosstab(df$aut, df$pej_antidem, "Political History", "Antidemocratic"), 
                  crosstab(df$aut, df$pej_hist, "Political History", "Historical"), 
                  crosstab(df$aut, df$pej_cont, "Political History", "Contemporary"), 
                  crosstab(df$aut, df$pej_ill, "Political History", "Illiberal"),
                  crosstab(df$aut, df$pej_pop, "Political History", "Populist"))
...
#dev.copy(png,paste0(fig_dir,'Figure C.1. - Analysis by Type of Pejoration.png'), width = 3600, height = 1800, res=400)
#dev.off()
```
